...
public class BlobTravelImageService : ITravelImageService
{
    ...
    public async Task<string> SaveImageAsync(string pinId, Stream imageStream, string fileName)
    {
        ...
        var blobPath = $"{pinId}/{imageId}.jpg";
    ...
    public async Task DeleteImageAsync(string pinId, string imageId)
    {
        var blobPath = $"{pinId}/{imageId}.jpg";
        var blobClient = _containerClient.GetBlobClient(blobPath);
    ...
    public async Task<(Stream stream, string contentType)?> GetImageAsync(string pinId, string imageId)
    {
        var blobPath = $"{pinId}/{imageId}.jpg";
        var blobClient = _containerClient.GetBlobClient(blobPath);
    ...
    public async Task DeleteAllImagesAsync(string pinId)
    {
        var prefix = $"{pinId}/";

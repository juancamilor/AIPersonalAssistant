...
Add these 9 secrets to your GitHub repository:
...
You're adding the 9 new secrets listed above (3 for Azure AD authentication + 3 for Exchange Rate APIs + 1 for Stock Tools + 2 for Taxes Manager).

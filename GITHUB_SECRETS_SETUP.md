...
| `AzureDocumentIntelligence:Endpoint` | `dotnet user-secrets set "AzureDocumentIntelligence:Endpoint" "value"` | `AZURE_DOCUMENT_INTELLIGENCE_ENDPOINT` | ✅ | ✅ |
| `AzureDocumentIntelligence:ApiKey` | `dotnet user-secrets set "AzureDocumentIntelligence:ApiKey" "value"` | `AZURE_DOCUMENT_INTELLIGENCE_API_KEY` | ✅ | ✅ |
| `Google:ClientId` | `dotnet user-secrets set "Google:ClientId" "value"` | `GOOGLE_CLIENT_ID` | ✅ | ✅ |
| `Google:ClientSecret` | `dotnet user-secrets set "Google:ClientSecret" "value"` | `GOOGLE_CLIENT_SECRET` | ✅ | ✅ |
...
Add these 11 secrets to your GitHub repository:
...
| Secret Name | Value | Purpose |
|------------|-------|---------|
| `AZURE_DOCUMENT_INTELLIGENCE_ENDPOINT` | `https://your-resource.cognitiveservices.azure.com/` | Document Intelligence endpoint |
| `AZURE_DOCUMENT_INTELLIGENCE_API_KEY` | `YOUR_DOC_INTELLIGENCE_KEY` | Document Intelligence API key |

### Google Authentication
| Secret Name | Value | Purpose |
|------------|-------|---------|
| `GOOGLE_CLIENT_ID` | `YOUR_GOOGLE_CLIENT_ID` | Google OAuth 2.0 Client ID from Google Cloud Console |
| `GOOGLE_CLIENT_SECRET` | `YOUR_GOOGLE_CLIENT_SECRET` | Google OAuth 2.0 Client Secret from Google Cloud Console |
...
6. Under **Authorized redirect URIs**, add: `https://my-personal-assistant-hub.azurewebsites.net/signin-google`
7. Copy the generated **Client ID** and **Client Secret** into your GitHub secrets
...
You're adding the 11 new secrets listed above (3 for Azure AD authentication + 3 for Exchange Rate APIs + 1 for Stock Tools + 2 for Taxes Manager + 2 for Google Authentication).
